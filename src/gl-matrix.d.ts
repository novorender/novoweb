...
declare module "gl-matrix" {
    ...
    export type ReadonlyQuat = [number, number, number, number];

    export type ReadonlyQuat2 = [number, number, number, number, number, number, number, number];

    export type ReadonlyVec2 = [number, number];
