...
import { selectManholeMeasureAgainst, selectManholeMeasureValues } from "features/manhole";
...
export function useCreateBookmark() {
    ...
    const manholeCollisionTarget = useAppSelector(selectManholeMeasureAgainst);
