...
export function CreateJsonGroup({
  ...
  const disableNext =
    ...
    !savedInputs.filter((input) =>
      input.property && (input.value || input.range)
    ).length;
        ...
        >
          ...
          >
            ...
            <Box mb={3} component="pre" textAlign="center">
              ...
              "searchPattern":{" "}
              <Link
                href={`https://api.novorender.com/docs/v0.4.0/interfaces/SearchPattern.html`}
              >
                SearchPattern
              </Link>
              []
            ...
            <TextField
              ...
              helperText={status === Status.SearchError
