...
import {
  explorerGlobalsActions,
  useExplorerGlobals,
} from "contexts/explorerGlobals";
...
export function Render3D() {
  ...
  const engine2dRenderFnRef = useRef<
    ((moved: boolean, idleFrame?: boolean) => void) | undefined
  >();
