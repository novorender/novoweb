    ...
    return useMemo(() => {
        ...
        return [
            ...
            },
            {
                ...
                label: `${t("features")} / ${t("beta")} / ${t("generatedParametricData")}`,
            },
            {
                ...
                label: `${t("features")} / ${t("beta")} / ${t("performanceStats")}`,
            },
            {
                ...
                label: `${t("features")} / ${t("beta")} / ${t("newDesign")}`,
            },
            {
