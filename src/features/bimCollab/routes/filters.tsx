                    ...
                    >
                        {extensions.topic_type.map((topicType) => (
                            <MenuItem
                                key={topicType}
                                value={topicType}
                                sx={{ fontWeight: filters[FilterType.Type].includes(topicType) ? "bold" : "regular" }}
                            >
                                {topicType}
                            </MenuItem>
                        ))}
                    ...
                    >
                        {extensions.topic_label.map((topicLabel) => (
                            <MenuItem
                                key={topicLabel}
                                value={topicLabel}
                                sx={{ fontWeight: filters[FilterType.Label].includes(topicLabel) ? "bold" : "regular" }}
                            >
                                {topicLabel}
                            </MenuItem>
                        ))}
                    ...
                    >
                        {extensions.topic_status.map((topicStatus) => (
                            <MenuItem
                                ...
                                value={topicStatus}
                                sx={{
                                    fontWeight: filters[FilterType.Status].includes(topicStatus) ? "bold" : "regular",
                                }}
                            >
                                {topicStatus}
                            </MenuItem>
