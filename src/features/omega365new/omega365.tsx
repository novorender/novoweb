...
export default function Omega365New() {
    const [menuOpen, toggleMenu] = useToggle();
    const minimized = useAppSelector(selectMinimized) === featuresConfig.omega365new.key;
    const maximized = useAppSelector(selectMaximized).includes(featuresConfig.omega365new.key);
    ...
    return (
        <>
            <WidgetContainer minimized={minimized} maximized={maximized}>
                ...
                {menuOpen && <WidgetList widgetKey={featuresConfig.omega365new.key} onSelect={toggleMenu} />}
            </WidgetContainer>
...
function DcoumentLoader({
    ...
    const isObjectSelected = Number.isFinite(mainObject);
